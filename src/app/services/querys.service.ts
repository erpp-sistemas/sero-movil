...
export class QuerysService {
  ...
  getTables() {
    ...
    let tableServicios = `CREATE TABLE IF NOT EXISTS serviciosPlazaUser (id INTEGER PRIMARY KEY AUTOINCREMENT, nombre TEXT, ape_pat TEXT, ape_mat TEXT, plaza TEXT, servicio TEXT, id_plaza INTEGER, id_servicio INTEGER, icono_app_movil TEXT, descargado BOOLEAN)`;
